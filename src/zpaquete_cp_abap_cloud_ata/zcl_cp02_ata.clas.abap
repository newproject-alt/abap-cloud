...
CLASS zcl_cp02_ata IMPLEMENTATION.
...
* Análisis de tipos genéricos vs potencial DDIC:
*
* 1. id_reserva (type i)
*    genérico
*    puede ser elemento de datos para: validaciones, rango, semántica clara...
*
* 2. aerolinea (c length 2)
*    técnico genérico; ideal para data element y la ayuda de búsqueda y consistencia.
*
* 3. num_vuelo (n length 4)
*    genérico que podría ser ZDE_NUM_VUELO con formato y ALPHA conversion exit.
*
* 4. pasajero (string)
*    genérico
*    se podria beneficiar de: etiquetas, búsqueda, validación de longitud...
*
* 5. fecha (d)
*    estándar SAP
*    podría mantenerse
*
* 6. precio (p decimals 2)
*    tecnico pero correcto técnicamente aunque debería ser ZDE_PRECIO_RESERVA para semántica (importe monetario)
*
* 7. estado (c length 1)
*    ideal para ZDE_ESTADO_RESERVA.

    data: ls_reservas type ty_reservas,
          lt_reservas type STANDARD TABLE OF ty_reservas.
