CLASS zcl_ata_table_type DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_ATA_TABLE_TYPE IMPLEMENTATION.
...
*    DATA addresses TYPE tt_addresses.
    DATA addresses TYPE zatat_addresses.
...
*    DATA person TYPE st_person_deep.
    DATA person TYPE zatas_person_deep.
...
*    DATA persons TYPE tt_persons.
    DATA persons TYPE zatat_persons.
